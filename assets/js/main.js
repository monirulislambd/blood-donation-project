...
$('.timer').countdown('2024/12/19 00:10:10', function(event) {
    if (event.elapsed) {
        $(this).html(event.strftime('<div class="cardbtn"><button class="btn view">Next Donet</button></div>'));
      }else{
        $(this).html(event.strftime('<p><span>%D</span><br>Day</p><p><span>%H</span><br>Hour</p> <p><span>%M</span><br>Minute</p> <p><span>%S</span><br>Second</p>'));
      }
  });
